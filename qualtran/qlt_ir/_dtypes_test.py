...
from qualtran.qlt_ir._dtypes import get_builtin_qdtype_mapping, reg_to_qdtype_node
from qualtran.qlt_ir._eval import eval_qdtype_node
...
def test_load_objectstring_safe(objectstring, expected):
    ...
    from qualtran.qlt_ir import load_objectstring
