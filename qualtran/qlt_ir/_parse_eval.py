...
from ._eval import BloqKey, eval_cvalue_node, eval_module
from ._parse import parse_module, parse_objectstring
...
def load_module(qlt_code: str, *, safe: bool = True) -> Dict[BloqKey, 'qlt.Bloq']:
    m = parse_module(qlt_code)
