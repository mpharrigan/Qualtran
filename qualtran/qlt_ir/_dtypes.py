...
from .nodes import CObjectNode, QDTypeNode, QltNodes
...
def to_qdtype_node(dtype: 'qlt.QCDType', *, nodes: QltNodes = qualtran_qlt_nodes) -> CObjectNode:
...
def reg_to_qdtype_node(reg: 'qlt.Register', *, nodes: QltNodes = qualtran_qlt_nodes) -> QDTypeNode:
