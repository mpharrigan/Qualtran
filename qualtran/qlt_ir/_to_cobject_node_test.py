...
from qualtran.qlt_ir._to_cobject_node import object_to_object_node, to_cobject_node
from qualtran.qlt_ir.nodes import CObjectNode, LiteralNode, TupleNode
...
def test_dump_objectstring():
    from qualtran.qlt_ir._to_cobject_node import dump_objectstring
