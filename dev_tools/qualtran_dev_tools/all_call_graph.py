...
from qualtran import Bloq, BloqExample, Adjoint, Controlled
from qualtran.bloqs.basic_gates import IntState, Rx, Ry, Rz, Toffoli, XPowGate, YPowGate, ZPowGate
...
def call_graph_to_class_graph(g: nx.Graph):
    ...
    g2 = g2.subgraph([k for k in g2.nodes if k != ArbitraryClifford])
    return g2
